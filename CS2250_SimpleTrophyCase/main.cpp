...
// Numerical Contants
constexpr auto MINIMUM_LEVEL = 1;
constexpr auto MAXIMUM_LEVEL = 50;
constexpr auto MAXIMUM_NAME_LENGTH = 30;

// Reusable strings
constexpr auto PROMPT_FOR_NAME = "Please enter the name of the Trophy:";
constexpr auto PROMPT_FOR_EXISTING_NAME = "Please enter the name of the existing Trophy:";
constexpr auto PROMPT_FOR_NEW_NAME = "Please enter the new name of the Trophy:";
constexpr auto PROMPT_FOR_LEVEL = "Please enter the level of your Trophy:";
constexpr auto PROMPT_FOR_COLOR = "Please enter the color of your Trophy: (GOLD, SILVER, or BRONZE)";
constexpr auto PROMPT_FOR_CASE_NUMBER = "Please enter the number of the case:";
constexpr auto PROMPT_FOR_CASE_NUMBER_COPY = "Please enter the number of the case to copy:";
constexpr auto PROMPT_FOR_CASE_NUMBER_OVERWRITE = "Please enter the number of the case to overwrite:";
constexpr auto MESSAGE_QUIT = "You have chosen to exit the application, good-bye!";
constexpr auto CONFIRM_CREATE_CASE = "You have chosen to create a new Trophy Case.";
constexpr auto CONFIRM_COPY_CASE = "You have chosen to copy an existing Trophy Case.";
constexpr auto CONFIRM_OVERWRITE_CASE = "You have chosen to overwrite a Trophy Case with another one.";
constexpr auto CONFIRM_DELETE_CASE = "You have chose to delete a Trophy Case.";
constexpr auto CONFIRM_ADD_TROPHY = "You have chosen to add a trophy.";
constexpr auto CONFIRM_DELETE_TROPHY = "You have chosen to delete an existing trophy.";
constexpr auto CONFIRM_COPY_TROPHY = "You have chosen to copy an existing trophy.";
constexpr auto CONFIRM_RENAME_TROPHY = "You have chosen to change the name of an existing trophy.";
constexpr auto CONFIRM_RELEVEL_TROPHY = "You have chosen to change the level of an existing trophy.";
constexpr auto CONFIRM_RECOLOR_TROPHY = "You have chosen to change the color of an existing trophy.";
constexpr auto CONFIRM_PRINT_TROPHIES = "You have chosen to print all of the trophies.";
constexpr auto ERROR_MENU_SELECTION = "That is not a recognized menu selection, choose again.";
constexpr auto ERROR_NAME = "That is not a valid name.  Try again.";
constexpr auto ERROR_INTEGER = "That value is outside the acceptable range.  Try again.";
constexpr auto ERROR_COLOR = "That is not an acceptable color.  Try again.";
constexpr auto ERROR_NO_CASES_EXIST = "There are no Trophy Cases.  Create one first.";
constexpr auto ERROR_TROPHY_CANNOT_BE_FOUND = "That trophy could not be found.";
...
int main()
{
	{
		/*
		Trophy test = Trophy("A", 1, GOLD);
		cout << test << endl;
		TrophyCase tCase = TrophyCase();
		tCase.addTrophy("B", 2, SILVER);
		cout << tCase << endl;
		*/
